...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("facility_name", sa.String(length=255), nullable=False, server_default=""),
        sa.Column("authority", sa.String(length=255), nullable=False, server_default=""),
        sa.Column("permit_number", sa.String(length=128), nullable=False, server_default=""),
        ...
        sa.Column("report_cron", sa.String(length=255), nullable=True),
    ...
    op.create_index("ix_compliance_parameters_permit_id", "compliance_parameters", ["permit_id"])

    op.create_table(
        "compliance_limits",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("compliance_parameter_id", sa.Integer(), nullable=False),
        sa.Column("limit_type", sa.String(length=32), nullable=False),
        sa.Column("min_value", sa.Float(), nullable=True),
        sa.Column("max_value", sa.Float(), nullable=True),
        sa.Column("aggregation", sa.String(length=32), nullable=False, server_default="instant"),
        ...
        sa.Column("requires_explanation", sa.Boolean(), nullable=False, server_default="0"),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
    ...
    op.create_index("ix_compliance_event_notes_event_id", "compliance_event_notes", ["event_id"])

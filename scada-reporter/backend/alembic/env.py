...
import app.models.compliance  # noqa: F401 — registers Compliance models with Base.metadata
...
import app.models.tag_group  # noqa: F401 — registers TagGroup with Base.metadata

  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="bg-gray-800 border border-gray-700 rounded-lg px-2 py-1 text-sm text-white focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50"
      >
